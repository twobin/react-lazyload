...
function isVisibleVertically(offsets, offsetTop, intersectionHeight, height) {
  return offsetTop - offsets[0] <= intersectionHeight &&
    offsetTop + height + offsets[1] >= 0;
}

function isVisibleHorizontally(xAxisLazyLoad, virtualWidth, left) {
  return xAxisLazyLoad ?
    left < virtualWidth && left >= -(virtualWidth / 2) :
    true;
}
...
var checkOverflowVisible = function checkOverflowVisible(component, parent) {
  ...
  var windowInnerHeight = window.innerHeight || document.documentElement.clientHeight,
      ...
      isHandheldDevice = parent.classList.contains('lazyload-handheld'),
      virtualWidth = (isHandheldDevice ? parentWidth : (parentWidth * 2));
  ...
  var offsets = Array.isArray(component.props.offset) ?
    component.props.offset :
    [component.props.offset, component.props.offset]; // Be compatible with previous API

  return isVisibleVertically(offsets, offsetTop, intersectionHeight, height) &&
    isVisibleHorizontally(xAxisLazyLoad, virtualWidth, left);
};
