...
var checkOverflowVisible = function checkOverflowVisible(component, parent) {
  ...
  var xAxisLazyLoad = parent.classList.contains('lazyload-x-axis');
  var isHandheldDevice = parent.classList.contains('lazyload-handheld');
  var virtualWidth = isHandheldDevice ? parentWidth : parentWidth * 2;
  ...
  return offsetTop - offsets[0] <= intersectionHeight && offsetTop + height + offsets[1] >= 0 && (xAxisLazyLoad ? left < virtualWidth && left >= 0 : true);
};
