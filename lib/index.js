...
var checkOverflowVisible = function checkOverflowVisible(component, parent) {
  ...
  var windowInnerHeight = window.innerHeight || document.documentElement.clientHeight,
      ...
      xAxisLazyLoadOffset = parent.dataset('lazyload-offset') || 0,
      device = parent.dataset('lazyload-device'),
      virtualWidth = (device === 'handheld' ? parentWidth : (parentWidth + parseInt(xAxisLazyLoadOffset)));
