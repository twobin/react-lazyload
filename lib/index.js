  ...
  _createClass(LazyLoad, [{
    ...
    value: function componentDidMount() {
      ...
      if (this.props.overflow) {
        var parent = null;
        if (this.props.scrollParentRef) parent = document.querySelector(this.props.scrollParentRef);else parent = (0, _scrollParent2.default)(_reactDom2.default.findDOMNode(this));
