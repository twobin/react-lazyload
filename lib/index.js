...
LazyLoad.propTypes = {
  ...
  height: _PropTypes.oneOfType([_PropTypes.number, _PropTypes.string]),
  offset: _PropTypes.oneOfType([_PropTypes.number, _PropTypes.arrayOf(_PropTypes.number)]),
  overflow: _PropTypes.bool,
  resize: _PropTypes.bool,
  scroll: _PropTypes.bool,
  children: _PropTypes.node,
  throttle: _PropTypes.oneOfType([_PropTypes.number, _PropTypes.bool]),
  debounce: _PropTypes.oneOfType([_PropTypes.number, _PropTypes.bool]),
  placeholder: _PropTypes.node,
  unmountIfInvisible: _PropTypes.bool
};
