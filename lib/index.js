...
var checkVisible = function checkVisible(component) {
  ...
  var offset = _component$props.offset;
  var _component$props$offsets = _component$props.offsets;
  var offsets = _component$props$offsets === undefined ? [] : _component$props$offsets;

  if (offsets.length < 2) {
    offsets = [offset, offset];
  }

  if (elementTop < scrollTop + windowInnerHeight + offsets[1] && elementTop + elementHeight + offsets[0] > scrollTop) {
...
LazyLoad.propTypes = {
  ...
  offsets: _react.PropTypes.array,
